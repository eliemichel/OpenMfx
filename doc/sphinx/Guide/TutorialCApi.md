...
Create a shared library project with your favorite C tool chain. Call your main source file for instance `mirror_plugin.c`, and copy along [the Open Mesh Effect include files](https://github.com/eliemichel/OpenMeshEffect/tree/master/include) to your project.
