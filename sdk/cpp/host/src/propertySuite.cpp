    ...
    void* value)
{
    ...
    if (false == OfxPropertySetStruct::check_property_context(
        props.context, PropertyType::Pointer, property)) {
    ...
    const char* value)
{
    ...
    if (false == OfxPropertySetStruct::check_property_context(
        props.context, PropertyType::String, property)) {
        return kOfxStatErrBadHandle;
    }
    if (index < 0 || index >= 4) {
        return kOfxStatErrBadIndex;
    ...
    double value)
{
    OfxPropertySetStruct& props = *properties;
    if (false == OfxPropertySetStruct::check_property_context(
        props.context, PropertyType::Double, property)) {
        return kOfxStatErrBadHandle;
    }
    if (index < 0 || index >= 4) {
        return kOfxStatErrBadIndex;
...
{
    if (false ==
        OfxPropertySetStruct::check_property_context(properties->context, PropertyType::Int, property)) {
        return kOfxStatErrBadHandle;
    }
    if (index < 0 || index >= 4) {
        return kOfxStatErrBadIndex;
...
OfxStatus propGetInt(OfxPropertySetHandle properties, const char* property, int index, int* value)
{
    OfxPropertySetStruct& props = *properties;
    if (false ==
        OfxPropertySetStruct::check_property_context(props.context, PropertyType::Int, property)) {
        return kOfxStatErrBadHandle;
    }
    if (index < 0 || index >= 4) {
        return kOfxStatErrBadIndex;
